...
export declare class MonthPickerComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MonthPickerComponent, "ion-calendar-month-picker", never, { "month": "month"; "color": "color"; "monthFormat": "monthFormat"; }, { "select": "select"; }, never, never, false, never>;
}
