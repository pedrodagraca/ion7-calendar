...
export declare class MonthComponent implements ControlValueAccessor, AfterViewInit {
    ...
    month: CalendarMonth;
    pickMode: PickMode | string | undefined;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MonthComponent, "ion-calendar-month", never, { "componentMode": "componentMode"; "month": "month"; "pickMode": "pickMode"; "isSaveHistory": "isSaveHistory"; "id": "id"; "readonly": "readonly"; "color": "color"; }, { "change": "change"; "select": "select"; "selectStart": "selectStart"; "selectEnd": "selectEnd"; }, never, never, false, never>;
}
